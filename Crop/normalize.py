# -*- coding: utf-8 -*-
"""
Created on Fri Mar  9 17:46:51 2018
Subtract the mean image of the dataset from each image (so, subtracting a 224x224x3 image from every image in the dataset).
[x] Subtract the channel means of the dataset from each image (so, subtracting a 1x 1x 3 vector from every image in the dataset).
